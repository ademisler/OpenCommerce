...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    addTag: 'Add tag',
    syncExternalApi: 'Sync with external API',
    value: 'Value',
    notifyStockBelow10: 'Notify me when stock drops below 10',
    autoTagOrdersOver100: 'Auto-tag new orders over €100',
  ...
  tr: {
    ...
    addTag: 'Etiket ekle',
    syncExternalApi: 'Harici API ile senkronize et',
    value: 'Değer',
    notifyStockBelow10: "Stok 10'un altına düştüğünde bildir",
    autoTagOrdersOver100: '100 € üzerindeki yeni siparişleri otomatik etiketle',
  ...
  fr: {
    ...
    syncExternalApi: "Synchroniser avec l'API externe",
    value: 'Valeur',
    notifyStockBelow10: 'Me notifier quand le stock passe sous 10',
    autoTagOrdersOver100: 'Étiqueter automatiquement les commandes de plus de 100 €',
